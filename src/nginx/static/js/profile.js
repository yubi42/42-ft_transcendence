...
function fetchProfileData() {
    ...
    .then(data => {
        ...
        document.getElementById('wins').textContent = data.stats["games-won"];
        document.getElementById('losses').textContent = data.stats["games-lost"];
		document.getElementById('draws').textContent = data.stats["games-draw"];
